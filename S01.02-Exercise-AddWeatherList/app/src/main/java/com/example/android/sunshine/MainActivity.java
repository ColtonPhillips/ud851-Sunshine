...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] weatherData = {"Freezing", "Cold", "Warm", "Hot", "Boiling", "Freezing", "Cold", "Warm", "Hot", "Boiling", "Freezing", "Cold", "Warm", "Hot", "Boiling", "Freezing", "Cold", "Warm", "Hot", "Boiling", "Freezing", "Cold", "Warm", "Hot", "Boiling"};
